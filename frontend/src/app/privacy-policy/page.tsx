  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-rose-50 to-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Privacy Policy for Aasan Rishte</CardTitle>
          ...
          <CardContent className="prose prose-gray max-w-none">
            <div className="space-y-6 text-sm leading-relaxed">
              ...
              <p>
                This Privacy Policy is an electronic record in the form of an electronic contract formed under the information Technology Act, 2000 and the rules made thereunder and the amended provisions pertaining to electronic documents / records in various statutes as amended by the information Technology Act, 2000.
              </p>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mt-8 mb-4">USER INFORMATION</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mt-8 mb-4">LINKS TO THE OTHER SITES</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mt-8 mb-4">INFORMATION SHARING</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mt-8 mb-4">INFORMATION SECURITY</h3>
              <p>
