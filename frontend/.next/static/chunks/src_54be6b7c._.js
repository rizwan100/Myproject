        ...
        try {
            ...
            if (response.ok) {
                ...
                if (error.detail === "Please verify your email before logging in") {
                    setError("root", {
                        message: "Please verify your email before logging in. Click here to resend verification email: /verification-pending?email=".concat(encodeURIComponent(data.email))
                    });
                } else {
                    setError("root", {
...
_s(LoginPage, "8+oo2jZgSU+LwH46A5ZSuCfCeAg=", false, function() {
    return [
...
//# sourceMappingURL=src_54be6b7c._.js.map