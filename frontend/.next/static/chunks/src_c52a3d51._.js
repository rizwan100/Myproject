...
function RegisterPage() {
    ...
    const onSubmit = async (data)=>{
        ...
        try {
            ...
            if (response.ok) {
                await response.json();
                router.push("/verification-pending?email=".concat(encodeURIComponent(data.email)));
            } else {
...
_s(RegisterPage, "KsC4CSol/+0gMs1NFNdsiONieiU=", false, function() {
    return [
...
//# sourceMappingURL=src_c52a3d51._.js.map