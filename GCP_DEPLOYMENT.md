...
steps:
  ...
  - name: 'gcr.io/cloud-builders/gcloud'
    ...
    - '--allow-unauthenticated'
    - '--set-env-vars'
    - 'GCP_BUCKET_NAME=aasan-rishte-uploads,DATABASE_URL=$$DATABASE_URL,JWT_SECRET=$$JWT_SECRET,EMAIL_HOST=$$EMAIL_HOST,EMAIL_PORT=$$EMAIL_PORT,EMAIL_USER=$$EMAIL_USER,EMAIL_PASSWORD=$$EMAIL_PASSWORD'
    - '--add-cloudsql-instances'
